        ...
        <div className="container-site hero-section__inner">
          <div className="hero-section__content">
            ...
            <p className="mt-4 max-w-xl text-sm text-text-muted">
              ...
              полным циклом: проектирование, монтаж систем вентиляции и кондиционирования,
              СМР, ПНР и сервисное обслуживание.
            </p>
          ...
          <Reveal>
            <div className="mb-10 max-w-2xl lg:mb-14">
              ...
              <p className="mt-4 text-lg text-text-muted">
                Полный цикл: от проектной документации до монтажа вентиляции и кондиционирования,
                ПНР, обслуживания и сдачи объекта.
              </p>
            </div>
          </Reveal>
